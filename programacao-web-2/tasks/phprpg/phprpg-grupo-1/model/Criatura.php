...
abstract class Criatura implements Generica
{
    ...
    public function atacar(){
        $coeficiente = ($this->nivel + $this->forca + $this->agilidade + ($this->magia * 0.1)) * mt_rand(1, 6);
        if ($coeficiente > 100)
            $coeficiente = 100;
    ...
    public function defender(){
        $coeficiente = ($this->agilidade + ($this->destreza * 1.8) + $this->inteligencia) * mt_rand(1, 6) + 10;
        if ($coeficiente > 100)
            $coeficiente = 100;
    ...
    public function perdeVida($vida){
